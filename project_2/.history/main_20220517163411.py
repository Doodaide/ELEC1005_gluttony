...
def introductions(player, color, gamemode):
    while True:
        ...
        small_message_display(message_dictionary[gamemode][0], 262.5, game.settings.height * 6, white, 10)
        small_message_display(message_dictionary[gamemode][1], 262.5, game.settings.height * 8, white, 10)
