...
def help_interface(player, color):
    ...
    while intro:
        ...
        button('Over and Under', widthvar - 170, 210, 100, 40, green, green, introductions, 'human', color, 'Over and Under')
        button('No Boundaries', widthvar - 50, 210, 100, 40, green, green, introductions, 'human', color, 'No Boundaries')
        button('Progressive', widthvar + 70, 210, 100, 40, green, green, introductions, 'human', color, 'Progressive')
